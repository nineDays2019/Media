//
// Created by yunrui on 2020-02-20.
...
int main(int argc, char **argv) {
    ...
    int src_rate = 48000,   // 输入 48 kHz
            dst_rate = 44100;   // 输出 44.1 kHz
    uint8_t **src_data = NULL,
            **dst_data = NULL;
    int src_nb_channels = 0, dst_nb_channels = 0;
    int src_linesize, dst_linesize;
    int src_nb_samples = 1024, dst_nb_samples, max_dst_nb_samples;
    enum AVSampleFormat src_sample_fmt = AV_SAMPLE_FMT_DBL, // 输入格式
            dst_sample_fmt = AV_SAMPLE_FMT_S16; // 输出格式
    ...
    // ?? = 1024 * 44100 / 48000
    // dst_nb_samples = src_nb_samples * dst_rate / src_rate
    // 这是什么换算公式
    // av_rescale_rnd()
