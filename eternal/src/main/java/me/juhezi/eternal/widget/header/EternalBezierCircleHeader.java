package me.juhezi.eternal.widget.header;
...
/**
 * 在 BezierCircleHeader 基础上进行修改
 */
public class EternalBezierCircleHeader extends View implements RefreshHeader {
    ...
    private int mHeaderBackColor = 0xff11bbff;
    private int mHeaderForeColor = 0xffffffff;

    private static final int TARGET_DEGREE = 270;

    public EternalBezierCircleHeader(Context context) {
        super(context, null, 0);
        initView(context, null);
    }

    public EternalBezierCircleHeader(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initView(context, attrs);
    }

    public EternalBezierCircleHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public EternalBezierCircleHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mBackPaint.setColor(mHeaderBackColor);
        mBackPaint.setAntiAlias(true);
        mFrontPaint = new Paint();
        mFrontPaint.setColor(mHeaderForeColor);
        mFrontPaint.setAntiAlias(true);
        mOuterPaint = new Paint();
        mOuterPaint.setAntiAlias(true);
        mOuterPaint.setColor(mHeaderForeColor);
    ...
    private void loadAttrs(AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray a =
                getContext().obtainStyledAttributes(attrs, R.styleable.CirCleRefreshLayout);
    ...
    public void onRefreshReleased(RefreshLayout layout, int headerHeight, int extendHeight) {
        ...
        waveAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                EternalBezierCircleHeader.this.invalidate();
            }
        });
